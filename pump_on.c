/*
 * pump_on.c - Turn ON the water pump by setting GPIO 23 HIGH
 * 
 * Usage: ./pump_on
 * Returns: 0 on success, 1 on failure
 * 
 * Compile: gcc -o pump_on pump_on.c -lgpiod
 */
...
int main(void) {
    ...
    // Create line settings for output, set HIGH
    ...
    printf("Pump ON (GPIO %d set HIGH)\n", GPIO_PUMP);

    // Cleanup - the line will stay HIGH after release
